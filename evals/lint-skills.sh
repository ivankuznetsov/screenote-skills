...
require_text evals/browser-use-mcp-smoke.sh "TIMEOUT_BrowserStartEvent" "smoke allows bounded cold browser startup"
require_text evals/browser-use-mcp-smoke.sh "TIMEOUT_BrowserLaunchEvent" "smoke allows bounded cold browser launch"
require_text evals/browser-use-mcp-smoke.sh "BROWSER_USE_EXECUTABLE_PATH" "CI smoke selects a known browser executable"
require_text mcp/screenote_browser_use_mcp.py "BROWSER_USE_EXECUTABLE_PATH" "adapter validates an explicit browser executable"
