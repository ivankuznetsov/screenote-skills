...
require_text .github/workflows/lint.yml "playwright==1.59.0" "CI pins the Browser Use-compatible Chromium release"
require_text .github/workflows/lint.yml "playwright install --with-deps chromium" "CI installs pinned Chromium and its dependencies"
